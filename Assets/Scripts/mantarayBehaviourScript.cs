...
public class mantarayBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("MantaRay");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "MantaRay(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0189f, 0.0329f, -0.0316f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, -49.473f);
        mBundleInstance.transform.localScale = new Vector3(1.534924f, 1.534924f, 1.534924f);
