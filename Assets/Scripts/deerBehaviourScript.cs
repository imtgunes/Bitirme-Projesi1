...
public class deerBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Deer(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0031f, 0f, -0.0107f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 40.468f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.03018189f, 0.03018189f, 0.03018189f);
