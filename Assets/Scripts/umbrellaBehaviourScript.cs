...
public class umbrellaBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Umbrella");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Umbrella(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.008975983f, 0.01417626f, 0.006161409f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-42.899f, -55.266f, 90f);
        mBundleInstance.transform.localScale = new Vector3(0.001233352f, 0.001233352f, 0.001233352f);
