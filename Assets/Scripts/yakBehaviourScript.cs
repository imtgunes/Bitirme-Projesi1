...
public class yakBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Yak(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0069f, 0f, -0.0135f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, -142.297f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.03225069f, 0.03225069f, 0.03225069f);
