...
public class quetzalBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Quetzal");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Quetzal(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0374f, 0.0322f, -0.0148f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-19.489f, 203.92f, -7.636f);
