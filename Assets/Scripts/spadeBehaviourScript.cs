...
public class spadeBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Spade");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Spade(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.011f, 0.0288f, 0.007647386f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-27.487f, 119.499f, -14.634f);
        mBundleInstance.transform.localScale = new Vector3(0.064555f, 0.064555f, 0.064555f);
