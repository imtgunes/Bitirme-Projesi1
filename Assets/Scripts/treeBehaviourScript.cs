...
public class treeBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Tree(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0010213f, 0.025003f, 0.002f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(90f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(-0.07767931f, -0.07767931f, -0.07767931f);
