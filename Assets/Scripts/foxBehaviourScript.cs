...
public class foxBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Fox(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.2572f, -1.115f, -0.0073f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-92.083f, 0f, 32.49699f);
        mBundleInstance.transform.localScale = new Vector3(-0.06306783f, -0.06306783f, -0.06306783f);
