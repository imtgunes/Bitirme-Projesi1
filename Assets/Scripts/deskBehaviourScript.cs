...
public class deskBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Desk(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0009760857f, 0.0176f, 0.004f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.02583167f, 0.02583167f, 0.02583167f);
