...
public class umbrellabirdBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("UmbrellaBird");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "UmbrellaBird(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0007f, 0.0104f, 0.0059f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90.443f, 0f, -166.761f);
        mBundleInstance.transform.localScale = new Vector3(0.001400252f, 0.001400252f, 0.001400252f);
