...
public class islandBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Island");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Island(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(1.9074e-06f, 0.028748f, 0.0023013f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.001488019f, 0.001488019f, 0.001488019f);
