...
public class jetBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Jet(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0165f, 0.0208f, 0.01209516f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.01250758f, 0.01250758f, 0.01250758f);
