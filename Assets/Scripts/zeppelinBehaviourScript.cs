...
public class zeppelinBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Zeppelin");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Zeppelin(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0059395f, 0.029325f, 0.014944f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(90f, 0f, 90f);
        mBundleInstance.transform.localScale = new Vector3(-0.01048484f, -0.01048484f, -0.01048484f);
