...
public class seaurchinBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("SeaUrchin");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "SeaUrchin(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0f, 0.058f, 0f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-89.98f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(100f, 100f, 100f);
