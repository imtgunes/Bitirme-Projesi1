...
public class keyboardBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Keyboard");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Keyboard(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(5.538f, -1.6402f, 0.5636f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, -178.336f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.04403215f, 0.04403215f, 0.04403215f);
