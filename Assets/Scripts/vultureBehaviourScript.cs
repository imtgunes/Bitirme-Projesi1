...
public class vultureBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Vulture");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Vulture(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.007f, 0.0032f, 0.0236f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, -70.873f);
        mBundleInstance.transform.localScale = new Vector3(0.000782057f, 0.000782057f, 0.000782057f);
