...
public class horseBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Horse");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Horse(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.006f, 0f, -0.002f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 21.816f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.04633102f, 0.04633102f, 0.04633102f);
