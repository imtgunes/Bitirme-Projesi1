...
public class beeBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Bee(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0046983f, -0.0086153f, -0.0038967f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-7.293f, -129.448f, 0f);
        mBundleInstance.transform.localScale = new Vector3(410.4252f, 410.4252f, 410.4252f);
