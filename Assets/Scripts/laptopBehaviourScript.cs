...
public class laptopBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Laptop");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Laptop(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0011978f, 0.011689f, 0.0084f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.03389577f, 0.03389577f, 0.03389577f);
