...
public class yachtBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Yacht");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Yacht(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.014908f, 0.0254f, 0.0127f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, -90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.003908673f, 0.003908673f, 0.003908673f);
