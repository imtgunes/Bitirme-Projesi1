...
public class flowerBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Flower");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Flower(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.002696991f, 0.0561f, 0.0017f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, -45f);
        mBundleInstance.transform.localScale = new Vector3(0.2017884f, 0.2017884f, 0.2017884f);
