...
public class koalaBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Koala");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Koala(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0051f, 0.0073f, -0.0133f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, 124.19f);
        mBundleInstance.transform.localScale = new Vector3(0.002273302f, 0.002273302f, 0.002273302f);
