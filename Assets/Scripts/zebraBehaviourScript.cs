...
public class zebraBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Zebra");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Zebra(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0106f, 0.0197f, 0.0054f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, -154.391f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.000719858f, 0.000719858f, 0.000719858f);
