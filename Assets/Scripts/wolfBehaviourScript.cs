...
public class wolfBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Wolf(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0012f, 0.0087f, -0.0064f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-86.264f, 0f, 207.678f);
        mBundleInstance.transform.localScale = new Vector3(0.0006278482f, 0.0006278482f, 0.0006278482f);
