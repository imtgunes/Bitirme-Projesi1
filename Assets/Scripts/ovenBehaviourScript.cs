...
public class ovenBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Oven(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0f, 0.012308f, 0.011f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, 180f);
        mBundleInstance.transform.localScale = new Vector3(0.05919519f, 0.05919519f, 0.05919519f);
