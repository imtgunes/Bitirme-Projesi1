...
public class carBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Car(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0f, 0.02f, 0.0098f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.03628677f, 0.03628677f, 0.03628677f);
