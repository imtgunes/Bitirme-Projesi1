...
public class elephantBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Elephant");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Elephant(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0022947f, 0.0417f, -0.012654f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, -238.25f);
        mBundleInstance.transform.localScale = new Vector3(1.239f, 1.239f, 1.239f);
