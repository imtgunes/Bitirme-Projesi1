...
public class lionBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Lion(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0062f, 0.0493f, -0.0022f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, 19.406f);
        mBundleInstance.transform.localScale = new Vector3(0.03881748f, 0.03881748f, 0.03881748f);
