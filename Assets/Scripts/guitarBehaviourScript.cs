...
public class guitarBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Guitar");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Guitar(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.05f, 0.022985f, 0.0077175f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(48.608f, -183.375f, -94.494f);
        mBundleInstance.transform.localScale = new Vector3(-0.0001181047f, -0.0001181047f, -0.0001181047f);
