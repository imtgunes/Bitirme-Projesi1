...
public class penguinBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Penguin");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Penguin(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0001716614f, 0.0051f, 0.005901337f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, 210.34f);
        mBundleInstance.transform.localScale = new Vector3(0.0006946002f, 0.0006946002f, 0.0006946002f);
