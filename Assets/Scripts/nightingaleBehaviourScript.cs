...
public class nightingaleBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Nightingale");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Nightingale(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.005f, 0.0092f, 0.0032f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-180.149f, 132.689f, -2.640015f);
        mBundleInstance.transform.localScale = new Vector3(0.68586f, 0.68586f, 0.68586f);
