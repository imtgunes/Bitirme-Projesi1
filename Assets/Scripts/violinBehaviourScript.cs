...
public class violinBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Violin");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Violin(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0329f, 0.0132f, 0.0184f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, -90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.05513204f, 0.05513204f, 0.05513204f);
