...
public class owlBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Owl(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0087f, 0.004f, -0.0185f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, -120.72f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.24635f, 0.24635f, 0.24635f);
