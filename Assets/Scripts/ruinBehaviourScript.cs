...
public class ruinBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Ruin(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0187f, -0.0017428f, 0.0392f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.01295934f, 0.01295934f, 0.01295934f);
