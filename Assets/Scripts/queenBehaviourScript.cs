...
public class queenBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Queen");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Queen(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0164f, 0.0105f, 0.014f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.004149513f, 0.004149513f, 0.004149513f);
