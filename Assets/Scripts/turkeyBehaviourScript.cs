...
public class turkeyBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Turkey");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Turkey(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0030499f, 0.0083f, -0.013489f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 0f, -57.739f);
        mBundleInstance.transform.localScale = new Vector3(0.001146583f, 0.001146583f, 0.001146583f);
