...
public class notebookBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Notebook");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Notebook(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.023f, 0.0126f, 0.0069f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.39863f, 0.39863f, 0.39863f);
