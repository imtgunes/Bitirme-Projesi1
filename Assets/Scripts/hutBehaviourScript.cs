...
public class hutBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "hut(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(2.861023e-06f, 0.0033f, 0.0148f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 180f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.01779617f, 0.01779617f, 0.01779617f);
