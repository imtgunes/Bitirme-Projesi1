...
public class bicycleBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Bicycle");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Bicycle(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0001657009f, 0.0346f, 0.0004f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.001184136f, 0.001184136f, 0.001184136f);
