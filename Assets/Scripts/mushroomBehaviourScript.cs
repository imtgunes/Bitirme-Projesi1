...
public class mushroomBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Mushroom");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Mushroom(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0018158f, 0.0289f, 0.013211f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.02521536f, 0.02521536f, 0.02521536f);
