...
public class planeBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Plane");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Plane(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(-0.0055463f, 0.0152f, 0.019099f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.001491184f, 0.001491184f, 0.001491184f);
