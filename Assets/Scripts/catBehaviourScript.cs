...
public class catBehaviourScript : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Cat(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0039f, 0.0062f, -0.003f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(180.049f, -143.306f, -0.0369873f);
        mBundleInstance.transform.localScale = new Vector3(0.07967091f, 0.07967091f, 0.07967091f);
