...
public class roosterBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Rooster");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Rooster(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0032f, 0.0088f, -0.0055f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 212.576f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.001357775f, 0.001357775f, 0.001357775f);
