...
public class easelBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Easel");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Easel(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.062977f, 0.0176f, 0.31507f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, -90f, 0f);
        mBundleInstance.transform.localScale = new Vector3(0.1129849f, 0.1129849f, 0.1129849f);
