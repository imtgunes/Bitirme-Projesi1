...
public class jellyfishBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("Jellyfish");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "Jellyfish(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.0045f, 0.0427f, -0.063437f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(0f, 0f, 0f);
        mBundleInstance.transform.localScale = new Vector3(25.7809f, 25.7809f, 25.7809f);
