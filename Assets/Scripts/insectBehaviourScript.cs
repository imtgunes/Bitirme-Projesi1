...
public class insectBehaviourScript : MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        myPrefab = GameObject.Find("insect");
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                if (collider.transform.name == "insect(Clone)")
                {
    ...
    public void showObject()
    {
        ...
        mBundleInstance.transform.localPosition = new Vector3(0.003004074f, 0.005999995f, 0.01054192f);
        mBundleInstance.transform.localRotation = Quaternion.Euler(-90f, 21.816f, -156.265f);
        mBundleInstance.transform.localScale = new Vector3(794.7389f, 794.7389f, 794.7389f);
